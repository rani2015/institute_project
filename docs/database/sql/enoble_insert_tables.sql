DELETE  TABLE ENOBLE.SCHEDULE;
DELETE  TABLE ENOBLE.TRAINER_BATCH ;
DELETE  TABLE ENOBLE.TRAINER ;
DELETE  TABLE ENOBLE.TRAINEE_BATCH ;
DELETE  TABLE ENOBLE.TRAINEE ;
DELETE  TABLE ENOBLE.COURSE_SECTION ;
DELETE  TABLE ENOBLE.BATCH ;

DELETE  TABLE ENOBLE.SECTION ;
DELETE  TABLE ENOBLE.COURSE ;
DELETE  TABLE ENOBLE.USER_T;
DELETE  TABLE ENOBLE.ADDRESS ;
DELETE  TABLE ENOBLE.ROLE ;

INSERT INTO ENOBLE.ROLE(ROLE_ID,ROLE_NAME,NOTE) VALUES('role1','ADMIN','Admin role user can insert,delete & update records in all tables');
INSERT INTO ENOBLE.ROLE(ROLE_ID,ROLE_NAME,NOTE) VALUES('role2','TRAINER','Trainer role user can insert,delete & update records in batch_trainer ,schedule tables');
INSERT INTO ENOBLE.ROLE(ROLE_ID,ROLE_NAME,NOTE) VALUES('role3','TRAINEE','Trainee role user can insert,delete & update records in only schedule table');
INSERT INTO ENOBLE.ROLE(ROLE_ID,ROLE_NAME,NOTE) VALUES('role4','MANAGEMENT','Managgement role user can request reports for all tables');

INSERT INTO ENOBLE.ADDRESS
(
ID NUMBER ,
...
INSERT INTO ENOBLE.COURSE_SECTION
(
ID	NUMBER(10) ,
...
INSERT INTO ENOBLE.TRAINEE_BATCH
(
...
INSERT INTO ENOBLE.TRAINER_BATCH
(
